 ...
 * @param conflicts    A list of {@link ConflictDto} objects detailing the detected conflicts.
 */
public record ValidationResponseDto(boolean hasConflicts, List<ConflictDto> conflicts) {
}
